...
- Connected the portal metrics and marketplace preview to live API data with honest empty states when no records exist.
- Replaced inaccurate footer stack claims with the stack the app actually runs today.
